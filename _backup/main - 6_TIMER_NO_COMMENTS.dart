...
// ==========================================
// SECTION 8 : ÉCRAN STATISTIQUES (FIX COURBE)
// ==========================================
...
// ==========================================
// SECTION 9 : RÉGLAGES (ESPACEMENT CORRIGÉ)
// ==========================================
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        // REGROUPEMENT DANS UN SEUL MODULE POUR RÉDUIRE L'ESPACE
        _glassModule(
          isDarkMode: widget.isDarkMode,
          child: Column(
            children: [
...
// ==========================================
// SECTION 10 : FEUILLE DE SAISIE (FIX HEURES)
// ==========================================
