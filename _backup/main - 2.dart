    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 25),
          // TEXTE DEGRÉ DYNAMIQUE ORANGE SANS DÉCIMALES
          Text(
            "DEGRÉ : ${_d.toInt()} %",
            style: TextStyle(
              color: widget.accentColor,
          ...
          const SizedBox(height: 10),
          // SLIDER AVEC THEME ET DÉGRADÉ SUR LA BARRE ACTIVE
          SliderTheme(
            data: SliderTheme.of(context).copyWith(
              // On cache la couleur de base pour laisser le ShaderMask faire le travail
              ...
              // Configuration de l'affichage de l'info-bulle (sans décimales)
              showValueIndicator: ShowValueIndicator.onDrag,
            ),
            child: Stack(
              alignment: Alignment.center,
              children: [
                // Couche Dégradé personnalisée pour la barre
                Padding(
                  padding: const EdgeInsets.symmetric(
                    horizontal: 20,
                  ), // Aligner avec le slider
                  child: ShaderMask(
                ...
                Slider(
                  ...
                  min: 0,
                  max: 50,
                  divisions: 50, // Pas de décimales = 50 divisions
                  label: "${_d.toInt()}%",
