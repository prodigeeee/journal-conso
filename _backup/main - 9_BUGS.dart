            ...
            return pw.Column(
              ...
              children: [
                      ...
                      pw.Container(
                        ...
                        child: pw.Column(
                          ...
                          children: [
                            ...
                            pw.Text(
                              "Bière: $totalB | Vin: $totalV | Spirit: $totalS",
                  ...
                  child: pw.GridView(
                    ...
                    children: [
                      ...
                      ...List.generate(daysInMonth, (index) {
                        ...
                        bool hasActivity =
                            dayConsos.isNotEmpty || contextsOfDay.isNotEmpty;
                        ...
                        return pw.Container(
                          ...
                          decoration: pw.BoxDecoration(
                            ...
                            color: hasActivity ? PdfColors.orange50 : null,
                          ),
                          child: pw.Column(
                            crossAxisAlignment: pw.CrossAxisAlignment.start,
                            children: [
                              ...
                              if (dayConsos.isNotEmpty)
                                pw.Column(
                                  crossAxisAlignment:
                                      pw.CrossAxisAlignment.start,
                                  children: dayConsos.map((c) {
                                    String icon = c.type == 'Bière'
                                        ? 'B'
                                        : c.type == 'Vin'
                                        ? 'V'
                                        : 'S';
                                    PdfColor color = c.type == 'Bière'
                                        ? PdfColors.orange800
                                        : c.type == 'Vin'
                                        ? PdfColors.red800
                                        : PdfColors.blue800;
                ...
                pw.Footer(
                  ...
                  trailing: pw.Text(
                    "B=Bière | V=Vin | S=Spiritueux - Page ${context.pageNumber}",
      ...
      sections: counts.entries
          .map(
            (e) => PieChartSectionData(
              ...
              color: e.key == 'Bière'
                  ? Colors.amber
                  : (e.key == 'Vin' ? Colors.redAccent : Colors.blueAccent),
