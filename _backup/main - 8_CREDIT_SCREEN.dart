...
class _OptionsScreenState extends State<OptionsScreen> {
    ...
    showDialog(
      ...
      builder: (c) => AlertDialog(
        backgroundColor: widget.isDarkMode
            ? const Color(0xFF1A1F26)
            : Colors.white,
        title: Text(title, style: TextStyle(color: widget.accentColor)),
        content: const Text("Les informations seront bientôt renseignées."),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(c),
  ...
  // FENÊTRE DES CRÉDITS AJUSTÉE (Position intermédiaire parfaite)
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    // On double la marge pour descendre sous le menton, vers la chaîne
