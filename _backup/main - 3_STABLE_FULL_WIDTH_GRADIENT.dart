...
class _StatsScreenState extends State<StatsScreen> {
  ...
  LineChartData _lineData() {
    ...
    List<Color> colors = [widget.accentColor, widget.accentColor];
    if (maxFound >= 4) colors = [widget.accentColor, Colors.orange, Colors.red];
...
class _SaisieSheetState extends State<_SaisieSheet> {
  ...
  TimeOfDay _getDefaultTime(String m) => (m == 'Matin')
